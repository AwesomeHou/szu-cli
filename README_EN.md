...
Build a portable AI IDE skill bundle:
...
Future state-changing commands, such as reservations, must begin with dry-run behavior and explicit confirmation. Gym reservation commands are not implemented yet.
